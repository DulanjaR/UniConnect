        ...
        <div className="flex gap-6 items-center">
          {user ? (
            <>
              ...
              <Link to="/groups/my" className="hover:text-accent-beige transition">
                My Groups
              </Link>
              <Link to="/groups/create" className="hover:text-accent-beige transition">
                Create Group
              </Link>
              <NotificationBell />
              {user.role === 'admin' && (
                <>
                  <Link to="/admin/groups" className="hover:text-accent-beige transition font-semibold">
                    Admin Groups
                  </Link>
                  <Link to="/admin/comments" className="hover:text-accent-beige transition font-semibold">
                    Admin Comments
                  </Link>
                </>
              )}
